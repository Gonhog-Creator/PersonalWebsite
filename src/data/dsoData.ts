...
export const dsoImages: DSOImage[] = [
  ...
  // Add more DSO objects with their details
  {
    ...
    catalogues: [
      ...
      { type: 'lbn', number: 191 },   // LBN 191
      { type: 'sh2', number: 103 },   // Sharpless 103
  ...
  },
  {
    ...
    catalogues: [
      ...
      { type: 'ugc', number: 6328 },
      { type: 'pgc', number: 34612 },
      { type: 'arp', number: 317 },
      // M66 (NGC 3627)
      { type: 'messier', number: 66 },
      { type: 'ngc', number: 3627 },
      { type: 'ugc', number: 6346 },
      { type: 'pgc', number: 34695 },
      { type: 'arp', number: 16 },
      { type: 'arp', number: 317 },
      // NGC 3628 (Hamburger Galaxy)
      { type: 'ngc', number: 3628 },
      { type: 'ugc', number: 6350 },
      { type: 'pgc', number: 34697 },
      { type: 'arp', number: 317 },
      // Group designations
  ...
  },
  {
    ...
    catalogues: [
      ...
      { type: 'ugc', number: 8493 },
      { type: 'pgc', number: 47404 },
      { type: 'arp', number: 85 },
