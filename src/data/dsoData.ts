  ...
  },
{
  ...
  },
  {
    ...
    processing: 'Reprocessed using data from multiple sessions. Stacked with Siril, processed with Astrosharp and Adobe Lightroom, with careful attention to preserving natural gradients and details.'
  },
  {
    id: 'dso-23',
    ...
    type: 'nebula',
    constellation: 'Cygnus',
    imageUrl: '/img/Astro/dso-23.jpg',
    telescope: 'Seestar S50',
    exposure: '345x30s (2h 52m 30s)',
    location: 'Durham, NC',
    year: 2024,
    catalogues: [
      { type: 'ic', number: 5146 },
  ...
  },
  {
    ...
    imageUrl: '/img/Astro/dso-24.jpg',
    telescope: 'Seestar S50',
    exposure: '198x10s (33m)',
    location: 'Durham, NC',
    year: 2024,
    catalogues: [
    ...
    processing: 'Stacked and processed using Siril, Astrosharp, and Adobe Lightroom. Processed to enhance the delicate structures in the nebula while maintaining natural star colors and contrast.'
  }
];
