...
export default function TechnicalSkills() {
  ...
  return (
    <section id="technical-skills" className="py-20 bg-gray-900">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-8">
          {skills.map((skill, index) => (
            <div 
              key={skill.name}
              className="flex flex-col items-center p-6 bg-gray-50 bg-gray-800 rounded-xl hover:shadow-lg transition-all duration-300 transform hover:-translate-y-1"
              data-aos="fade-up"
