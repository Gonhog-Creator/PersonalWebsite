...
const getImagePath = (id: number) => {
  const basePath = '/img/Estonia/Estonia';
...
const PAGE_CONTENT = {
  title: 'Estonia',
  description: 'Medieval city center with some modern innovation. Tallin is a an old soul with a new heart.',
  header: {
    backgroundImage: '/img/Estonia/estonia-panorama (2).jpg',
    altText: 'Estonia Panorama'
  },
  panoramas: {
    description: 'Lot\'s of aancient stone homes.',
...
const getPanoramaPath = (id: number) => {
  return `/img/Estonia/estonia-panorama (${id}).jpg`;
};

//STEP FOUR - change image number and panorama size below
export default function EstoniaGallery() {
