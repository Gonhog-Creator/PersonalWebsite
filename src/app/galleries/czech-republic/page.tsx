...
const getImagePath = (id: number) => {
  const basePath = '/img/Czech Republic/czech-republic';
...
const PAGE_CONTENT = {
  ...
  description: 'A city beautiful year round, day and night, and filled with amazing views, Prague was worth every second.',
  header: {
    backgroundImage: '/img/Czech Republic/czech-republic-panorama (4).jpg',
    altText: 'Czech Republic Panorama'
  },
  panoramas: {
    description: 'Lot\'s of bridges, lots of churches, and lots of statues.',
    imagePath: '/img/Czech Republic/czech-republic-panorama'
  },
  video: {
    id: 'uRk4IkVtkCY',
    title: 'Prague 2025 Recap'
  }
};

// STEP THREE Get the number of panorama images
const panoramaCount = 12;

//STEP FOUR
export default function CzechRepublicGallery() {
