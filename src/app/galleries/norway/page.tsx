...
const getImagePath = (id: number) => {
  const basePath = '/img/Norway/norway';
...
const PAGE_CONTENT = {
  title: 'Norway',
  description: 'Land of fjords and fish. Got hit with some misty days, but the sunset over also above the clouds was beautiful. Oh, and kicking babies.',
  header: {
    backgroundImage: '/img/Norway/norway-panorama (5).jpg',
    altText: 'Norway Panorama'
  },
  panoramas: {
    description: 'Mountain vistas and freezing cold water. The Opera House was stunning.',
...
const getPanoramaPath = (id: number) => {
  return `/img/Norway/norway-panorama (${id}).jpg`;
};

//STEP FOUR - change image number and panorama size below
export default function NorwayGallery() {
  // Generate gallery images with useMemo
  const galleryImages = useMemo<GalleryImage[]>(() => {
    return Array.from({ length: 179 }, (_, i) => {
