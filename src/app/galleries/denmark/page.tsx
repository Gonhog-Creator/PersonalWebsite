...
const getImagePath = (id: number) => {
  const basePath = '/img/Denmark/denmark';
...
const PAGE_CONTENT = {
  title: 'Denmark',
  description: 'Exploring the hundreds of islands of Denmark, filled with culture, history, and unique architecture. It was a bit chilly, I\'ll be honest.',
  header: {
    backgroundImage: '/img/Denmark/denmark-panorama (7).jpg',
    altText: 'Denmark Panorama'
  },
  panoramas: {
    description: 'Lots of cool bridges and extremely unique buildlings.',
...
const getPanoramaPath = (id: number) => {
  return `/img/Denmark/denmark-panorama (${id}).jpg`;
};

//STEP FOUR - change image number and panorama size below
export default function DenmarkGallery() {
