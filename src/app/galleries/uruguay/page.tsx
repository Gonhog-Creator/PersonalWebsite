...
const getImagePath = (id: number) => {
  const basePath = '/img/Uruguay/uruguay';
...
const PAGE_CONTENT = {
  title: 'Uruguay',
  description: 'Golden beaches, stunning sunsets, and vibrant blue waves under the moonlight. Welcome to Punta Del Este, Uruguay, where the only thing to do is relax.',
  header: {
    backgroundImage: '/img/Uruguay/uruguay_panorama (3).jpg',
    altText: 'Uruguay Panorama'
  },
  panoramas: {
    description: 'I tried to fly high enough to see Argentina. No dice.',
    imagePath: '/img/Uruguay/uruguay_panorama '
  },
  video: {
    id: 'KL7dlzAiLVY',
    title: 'Uruguay From Above'
  }
};


// Get the number of panorama images
const panoramaCount = 5; // Update this number based on your actual panorama count

//STEP FOUR
export default function UruguayGallery() {
