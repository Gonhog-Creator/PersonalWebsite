...
const getImagePath = (id: number) => {
  const basePath = '/img/Italy/Florence/florence';
...
const PAGE_CONTENT = {
  title: 'Florence',
  description: 'Home of Galileo, Michelangelo\'s David, and the Duomo, welcome to Italy\'s center of Renaissance.',
  header: {
    backgroundImage: '/img/Italy/Florence/florence-panorama (7).jpg',
    altText: 'Florence Panorama'
  },
  panoramas: {
    description: 'Lot\'s of bridges, lots of churches, and lots of statues.',
    imagePath: '/img/Italy/Florence/florence-panorama'
  },
  video: {
    id: '4mmNlOjjt0g',
    title: 'Florence 2025 Travel Recap'
  }
};

// STEP THREE Get the number of panorama images
const panoramaCount = 10;

//STEP FOUR
export default function FlorenceGallery() {
