...
const PAGE_CONTENT = {
  title: 'Rome',
  description: 'The Plaza de Spagna, the Colosseum, and the Pantheon, all thrown together in the heart of Rome and surrounded by so much history it was hard to comprehend.',
  header: {
    backgroundImage: '/img/Italy/Rome/rome-panorama (2).jpg',
    altText: 'Rome Panorama'
  },
  panoramas: {
    description: 'I feel like the Russel Crowe with all these ruins around me.',
    imagePath: '/img/Italy/Rome/rome-panorama'
  },
  video: {
    id: '',
    title: 'Rome 2025 Travel Recap'
  }
};
