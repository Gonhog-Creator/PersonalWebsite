...
const imageDetails: Record<number, { alt: string }> = {
  ...
  // Example:
  // 1: { alt: 'Big Ben and the Houses of Parliament' },
  // 2: { alt: 'Edinburgh Castle' },
};
...
export default function UKGallery() {
  ...
  return (
    <div className="min-h-screen bg-white">
      <GalleryNavbar currentPath="/galleries/uk" />

      <ProjectHeader
        title="United Kingdom"
        subtitle="Photography collection from the United Kingdom"
        backgroundImage="/img/UK/hero.jpg"
      />
