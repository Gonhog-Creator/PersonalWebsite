...
const panoramaLocations = [
  ...
  { id: 2, location: 'Edinburgh' },
  { id: 3, location: 'Bath' },
  { id: 4, location: 'York' },
  { id: 5, location: 'Cambridge' },
  { id: 6, location: 'Oxford' },
  { id: 7, location: 'Bath' },
  { id: 8, location: 'Stratford-upon-Avon' },
        ...
        {currentView === 'drone' && (
          <div className="w-full flex justify-center items-center min-h-screen py-16">
            <div className="w-full max-w-6xl px-4 flex flex-col items-center">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-12 text-center">United Kingdom Recap Coming Soon!</h2>
