...
const PAGE_CONTENT = {
  ...
  header: {
    backgroundImage: '/img/Argentina/argentina_panorama (3).jpg',
  ...
  video: [
    ...
    {
      id: 'xjH0jUnvUPE',
      title: 'A Taste of Los Picabueyes'
    },
    {
      id: 'UBHQtwZpIk0',
      title: 'Argentina 2025 Full Recap'
    }
  ]
};
...
const panoramaCount = 51; // Update this number based on your actual panorama count

//STEP FOUR
export default function ArgentinaGallery() {
  // Generate gallery images with useMemo
  const galleryImages = useMemo<GalleryImage[]>(() => {
    return Array.from({ length: 397 }, (_, i) => {
